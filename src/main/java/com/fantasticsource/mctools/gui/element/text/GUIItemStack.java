...
public class GUIItemStack extends GUIText
{
    ...
    {
        super(screen, stack.isEmpty() ? TextFormatting.GOLD + "(Empty Slot)" : "" + TextFormatting.GOLD + stack.getCount() + "x " + TextFormatting.RESET + stack.getDisplayName());
        this.stack = stack;
    ...
    {
        super(screen, x, y, stack.isEmpty() ? TextFormatting.GOLD + "(Empty Slot)" : "" + TextFormatting.GOLD + stack.getCount() + "x " + TextFormatting.RESET + stack.getDisplayName());
        this.stack = stack;
    ...
    {
        this.stack = stack;
        text = stack.isEmpty() ? TextFormatting.GOLD + "(Empty Slot)" : "" + TextFormatting.GOLD + stack.getCount() + "x " + TextFormatting.RESET + stack.getDisplayName();
